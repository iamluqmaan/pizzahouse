...
if(isset($_POST['submit'])){
  ...
  // ckecking if the ckeckbox is selected
    ...
    $sql = "INSERT INTO pizzahouse_pepperoni
      (phoneNos, address, toppings, pizzaSize, quantity, delivery, saveDetails) 
          VALUES
...
<section class="p-3">
   <div class="img-div p-2"> <img src="../images/pizza10.png"class="img" alt=""></div>
